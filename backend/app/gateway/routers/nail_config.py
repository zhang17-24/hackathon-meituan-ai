...
_NAIL_TOOL_META = [
    ...
    ("nail_consult_tool",        "智能咨询",   "🪄", "统一处理知识问答和款式推荐，自动路由到知识库或推荐链",            "nail",     False, False),
    ("knowledge_retrieval_tool", "知识检索",   "📚", "检索美甲专业知识库，返回最相关的知识片段与来源",                  "nail",     False, False),
    ("query_rewrite_tool",       "查询改写",   "🧠", "将自然语言问题改写为结构化检索条件，辅助知识和款式召回",          "nail",     False, False),
