"""Pure-argument factory for nailflow agents.

``create_nailflow_agent`` accepts plain Python arguments — no YAML files, no
...
from nailflow.agents.features import RuntimeFeatures
from nailflow.agents.middlewares.clarification_middleware import ClarificationMiddleware
from nailflow.agents.middlewares.dangling_tool_call_middleware import DanglingToolCallMiddleware
from nailflow.agents.middlewares.tool_error_handling_middleware import ToolErrorHandlingMiddleware
from nailflow.agents.thread_state import ThreadState
from nailflow.tools.builtins import ask_clarification_tool
...
def create_nailflow_agent(
    ...
    *,
    ...
    """Create a nailflow agent from plain Python arguments.
    ...
    *,
    ...
    if feat.sandbox is not False:
        if isinstance(feat.sandbox, AgentMiddleware):
            ...
            from nailflow.agents.middlewares.thread_data_middleware import ThreadDataMiddleware
            from nailflow.agents.middlewares.uploads_middleware import UploadsMiddleware
            from nailflow.sandbox.middleware import SandboxMiddleware
    ...
    if feat.vision is not False:
        ...
        if feat.sandbox is not False:
            from nailflow.tools.builtins import view_image_tool
    ...
    if feat.subagent is not False:
        ...
        from nailflow.tools.builtins import task_tool
