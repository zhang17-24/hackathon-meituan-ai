...
from nailflow.config.agents_config import load_agent_soul
from nailflow.skills.storage import get_or_new_skill_storage
from nailflow.skills.types import Skill, SkillCategory
from nailflow.subagents import get_available_subagent_names
...
def _start_enabled_skills_refresh_thread() -> None:
    threading.Thread(
        ...
        name="nailflow-enabled-skills-loader",
        daemon=True,
    ).start()
...
def _build_available_subagents_description(available_names: list[str], bash_available: bool, *, app_config: AppConfig | None = None) -> str:
    ...
    from nailflow.subagents.registry import get_subagent_config
...
nailflow is an open-source AI agent framework that gained significant traction in early 2026
[citation:GitHub Repository](https://github.com/bytedance/nail-flow). The project focuses on
providing a production-ready agent system with sandbox execution and memory management
[citation:nailflow Documentation](https://nail-flow.dev/docs).
...
### Primary Sources
- [GitHub Repository](https://github.com/bytedance/nail-flow) - Official source code and documentation
- [nailflow Documentation](https://nail-flow.dev/docs) - Technical specifications
...
- ✅ RIGHT in Sources: `[GitHub Repository](https://github.com/bytedance/nail-flow) - 官方源代码和文档`
...
def _get_memory_context(agent_name: str | None = None, *, app_config: AppConfig | None = None) -> str:
    ...
    """
    try:
        from nailflow.agents.memory import format_memory_for_injection, get_memory_data
...
def get_deferred_tools_prompt_section(*, app_config: AppConfig | None = None) -> str:
    ...
    """
    from nailflow.tools.builtins.tool_search import get_deferred_registry
...
def _build_acp_section(*, app_config: AppConfig | None = None) -> str:
    ...
    if app_config is None:
        try:
            from nailflow.config.acp_config import get_acp_agents
...
def apply_prompt_template(
    ...
    *,
    ...
    base_prompt = SYSTEM_PROMPT_TEMPLATE.format(
        agent_name=agent_name or "nailflow 2.0",
