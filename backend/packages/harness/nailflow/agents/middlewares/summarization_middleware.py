"""Summarization middleware extensions for nailflow."""
...
from nailflow.agents.middlewares.dynamic_context_middleware import is_dynamic_context_reminder
from nailflow.agents.middlewares.tool_call_metadata import clone_ai_message_with_tool_calls
...
class nailflowSummarizationMiddleware(SummarizationMiddleware):
