...
class CheckpointerConfig(BaseModel):
    ...
    type: CheckpointerType = Field(
        ...
        "'postgres' persists to PostgreSQL (install with nailflow-harness[postgres])."
    )
    connection_string: str | None = Field(
        ...
        "For sqlite, use a file path like '.nail-flow/checkpoints.db' or ':memory:' for in-memory. "
