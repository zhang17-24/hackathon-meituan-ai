...
class SandboxConfig(BaseModel):
    ...
    AioSandboxProvider specific options:
        ...
        container_prefix: Prefix for container names (default: nail-flow-sandbox)
    ...
    use: str = Field(
        ...,
        description="Class path of the sandbox provider (e.g. nailflow.sandbox.local:LocalSandboxProvider)",
    )
