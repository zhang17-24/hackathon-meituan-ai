...
from nailflow.mcp.client import build_servers_config
from nailflow.mcp.oauth import build_oauth_tool_interceptor, get_initial_oauth_headers
from nailflow.mcp.session_pool import get_session_pool
...
async def get_mcp_tools() -> list[BaseTool]:
    ...
    try:
        ...
        # Patch tools to support sync invocation, as nailflow client streams synchronously
