...
from nailflow.runtime.serialization import serialize
from nailflow.runtime.stream_bridge import StreamBridge
from nailflow.runtime.user_context import get_effective_user_id
from nailflow.tracing import inject_langfuse_metadata
    ...
    *,
    ...
    try:
        ...
        if event_store is not None:
            from nailflow.runtime.journal import RunJournal
        ...
        # Shared helper with ``nailflowClient.stream`` so both entry points stay
