...
consumer side of this module lives in ``nailflow.persistence.*``):
...
_current_user: Final[ContextVar[CurrentUser | None]] = ContextVar("nailflow_current_user", default=None)
