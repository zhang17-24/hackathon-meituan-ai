...
from nailflow.agents.thread_state import ThreadDataState
from nailflow.config import get_app_config
from nailflow.config.paths import VIRTUAL_PATH_PREFIX
from nailflow.sandbox.exceptions import (
    SandboxError,
    SandboxNotFoundError,
    SandboxRuntimeError,
)
from nailflow.sandbox.file_operation_lock import get_file_operation_lock
from nailflow.sandbox.sandbox import Sandbox
from nailflow.sandbox.sandbox_provider import get_sandbox_provider
from nailflow.sandbox.search import GrepMatch
from nailflow.sandbox.security import LOCAL_HOST_BASH_DISABLED_MESSAGE, is_host_bash_allowed
from nailflow.tools.types import Runtime
...
def _get_mcp_allowed_paths() -> list[str]:
    ...
    allowed_paths = []
    try:
        from nailflow.config.extensions_config import get_extensions_config
