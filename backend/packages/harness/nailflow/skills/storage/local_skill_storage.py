...
from nailflow.config.runtime_paths import resolve_path
from nailflow.skills.storage.skill_storage import SKILL_MD_FILE, SkillStorage
from nailflow.skills.types import SkillCategory
...
class LocalSkillStorage(SkillStorage):
    ...
    async def ainstall_skill_from_archive(self, archive_path: str | Path) -> dict:
        ...
        from nailflow.skills.installer import (
