...
from nailflow.subagents.builtins import BUILTIN_SUBAGENTS
from nailflow.subagents.config import SubagentConfig
...
def _resolve_subagents_app_config(app_config: Any | None = None):
    if app_config is None:
        from nailflow.config.subagents_config import get_subagents_app_config
