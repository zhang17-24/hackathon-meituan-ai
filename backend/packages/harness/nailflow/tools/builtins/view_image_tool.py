...
def _sanitize_image_error(error: Exception, thread_data: ThreadDataState | None) -> str:
    from nailflow.sandbox.tools import mask_local_paths_in_output
...
def view_image_tool(
    ...
    """
    from nailflow.sandbox.exceptions import SandboxRuntimeError
    from nailflow.sandbox.tools import (
        get_thread_data,
