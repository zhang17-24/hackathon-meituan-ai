...
from nailflow.sandbox.security import is_host_bash_allowed
from nailflow.tools.builtins import ask_clarification_tool, present_file_tool, task_tool, view_image_tool
from nailflow.tools.builtins.tool_search import get_deferred_registry
from nailflow.tools.sync import make_sync_tool_wrapper
...
def _is_host_bash_tool(tool: object) -> bool:
    ...
    if group == "bash":
        return True
    if use == "nailflow.sandbox.tools:bash_tool":
        return True
    return False
...
def get_available_tools(
    ...
    *,
    ...
    `initialize_mcp_tools()` from nailflow.mcp module.
    ...
    if getattr(skill_evolution_config, "enabled", False):
        from nailflow.tools.skill_manage_tool import skill_manage_tool
    ...
    if include_mcp:
        try:
            ...
            from nailflow.mcp.cache import get_cached_mcp_tools
            ...
            if extensions_config.get_enabled_mcp_servers():
                ...
                if mcp_tools:
                    ...
                    if config.tool_search.enabled:
                        from nailflow.tools.builtins.tool_search import DeferredToolRegistry, set_deferred_registry
                        from nailflow.tools.builtins.tool_search import tool_search as tool_search_tool
    ...
    try:
        from nailflow.tools.builtins.invoke_acp_agent_tool import build_invoke_acp_agent_tool
