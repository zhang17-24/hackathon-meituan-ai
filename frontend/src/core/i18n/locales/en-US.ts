...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 nailflow, an open source super agent. With built-in and custom skills, nailflow helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of nailflow. With customized skills,\nnailflow can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. nailflow is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but nailflow could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "nailflow's official website",
    githubTooltip: "nailflow on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "nailflow on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About nailflow",
    logout: "Log out",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to nailflow",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate nailflow faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how nailflow looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "nailflow automatically learns from your conversations in the background. These memories help nailflow understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of nailflow.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "nailflow only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
